    ...
    <div class="container">
        <div class="row row1">
            <ul class="largenav pull-right">
                <li class="upper-links"><a class="links" href="\Piscine\public\"> Accueil </a></li>
                <li class="upper-links"><a class="links" href="\Piscine\public\client\profil\"> Profil </a></li>
                <li class="upper-links"><a class="links" href="\Piscine\public\client\reservation\"> Réservation </a></li>
                <li class="upper-links"><a class="links" href="\Piscine\public\client\panier\"> panier </a></li>
        ...
        <div class="row row2">
            <div class="col-sm-2">
                <h2 style="margin:0px;"><span class="smallnav menu" onclick="openNav()">☰ CCI</span></h2>
                <h1 style="margin:0px;"><span class="largenav">CCI</span></h1>
            </div>
...
<div id="mySidenav" class="sidenav">
    <div class="container" style="background-color: #13f049; padding-top: 10px;">
